...
-- Полностью безопасен от детектов анти-читов
...
local gui, overlay, blur, window, winStroke, accentLine, tabsFrame, content, topbar
...
-- Cleanup при разрушении PlayerGui
